    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (statee.equals("Istanbul")) {
                    ...
                    ArrayAdapter<String> arrayAdapter =
                            new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, list);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()) {
                    register_user(fname, lname, emailid, mobile, password, Area, house, Postcode);
                }
            }
        });
...
FAuth.createUserWithEmailAndPassword(emailid,password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
    ...
    public void onComplete(@NonNull Task<AuthResult> task) {
        if (task.isSuccessful()){
            ...
            databaseReference.child("Customer").child(FAuth.getCurrentUser().getUid())
                    .setValue(hashMap).addOnCompleteListener(Registeration.this, new OnCompleteListener<Void>() {
                @Override
                public void onComplete(@NonNull Task<Void> task) {
                     if (task.isSuccessful()){
                         Toast.makeText(Registeration.this, "Succesfull", Toast.LENGTH_SHORT).show();
                     }
                }
            });
        }
    ...
    public boolean isValid() {
        ...
        boolean isValidname = false, isValidemail = false,
                isvalidpassword = false, isvalidconfirmpassword = false, isvalid = false,
                isvalidmobileno = false, isvalidlname = false, isvalidhousestreetno = false,
                isvalidarea = false, isvalidpostcode = false;
        ...
        if (TextUtils.isEmpty(lname)) {
            ...
            Lname.setError("Soyisim alanı boş bırakılamaz.");
        } else {
            isvalidlname = true;
        }
        if (TextUtils.isEmpty(emailid)) {
            ...
            isValidemail = true;
              ...
              Email.setErrorEnabled(true);
              Email.setError("Geçersiz email yazımı.");
            }
        }
        ...
        if (TextUtils.isEmpty(confirmpassword)) {
            ...
            cfpass.setError("Şifre tekrarı boş bırakılamaz.");
        } else {
            if (!password.equals(confirmpassword)) {
                Pass.setErrorEnabled(true);
                Pass.setError("Şifreler aynı değil.");
            } else {
        ...
        if (TextUtils.isEmpty(mobile)) {
            ...
            mobileno.setError("Telefon numarası alanı boş bırakılamaz.");
        } else {
            isvalidmobileno = true;
        }
        if (TextUtils.isEmpty(house)) {
            houseno.setErrorEnabled(true);
            houseno.setError("Bu alan boş bırakılamaz.");
        } else {
        ...
        if (TextUtils.isEmpty(Postcode)) {
            ...
            postcode.setError("Bu alan boş bırakılamaz.");
        } else {
            isvalidpostcode = true;
        }
        isvalid = (isValidname && isvalidpostcode && isvalidlname && isValidemail && isvalidconfirmpassword &&
                isvalidpassword && isvalidmobileno && isvalidarea && isvalidhousestreetno) ? true : false;
        return isvalid;
    }
}