...
public class Chef_PostDish extends AppCompatActivity {
    ...
    private boolean isValid() {
        ...
        if (TextUtils.isEmpty(price)) {
            ...
            pri.setError("Ücret yazmanız gerklidir.");
        } else {
            isValidPrice = true;
        }
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        firebaseDatabase.getInstance().getReference().child("FoodSupplyDetails").child(RandomUId)

                                    .setValue(info).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    progressDialog.dismiss();
                                    Toast.makeText(Chef_PostDish.this, "Başarılı", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(this, "Kesme başarılı.", Toast.LENGTH_SHORT).show();
            } else if (resultCode == CropImage.CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE) {
                Toast.makeText(this, "Kesme başarısız" + result.getError(), Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (mCropimageuri != null && grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(this, "Gerekli izin verilmediğinden iptal edildi", Toast.LENGTH_SHORT).show();
        }
    }
