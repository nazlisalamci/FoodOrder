...
import com.food_order.app.SendNotification.APIService;
import com.food_order.app.SendNotification.Client;
import com.food_order.app.SendNotification.Data;
import com.food_order.app.SendNotification.MyResponse;
import com.food_order.app.SendNotification.NotificationSender;
                ...
                if (cartModelList.size() == 0) {
                    ...
                    remove.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setMessage("Bu yiyeceği kaldırmak istediğinize emin misiniz?");
                                    ...
                                    FirebaseDatabase.getInstance().getReference("AlreadyOrdered").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("isOrdered").addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            ...
                                            if (ss.trim().equalsIgnoreCase("false") || ss.trim().equalsIgnoreCase("")) {
                                                                                                                            ...
                                                                                                                            public void onSuccess(Void aVoid) {
                                                                                                                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(ChefId).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                                                    ...
                                                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                                        ...
                                                                                                                                        sendNotifications(usertoken, "Yeni Sipariş", "Yeni bir Siparişiniz var", "Order");
                                                                                                                                        progressDialog.dismiss();
                                                                                                                                        ReusableCodeForAll.ShowAlert(getContext(), "", "Sipariş işleminiz gerçekleşti.Ödeme işlemine geçmeden önce şef onayını bekleyiniz.");
                                                                                                                                    }
                                                                                                                                    @Override
                                                ...
                                                ReusableCodeForAll.ShowAlert(getContext(), "HATA", "Zaten sipariş verdiniz. Aynı siparişi tekrar oluşturamazsınız.");
                                            }
                                        }
                                        @Override
                                        public void onCancelled(@NonNull DatabaseError databaseError) {}
