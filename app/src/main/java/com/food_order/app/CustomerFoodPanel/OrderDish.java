...
import com.food_order.app.ChefFoodPanel.UpdateDishModel;
import com.food_order.app.Customer;
import com.food_order.app.CustomerFoodPanel_BottomNavigation;
...
public class OrderDish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataaa = FirebaseDatabase.getInstance().getReference().child("Customer").child(userid);
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference().child("FoodSupplyDetails").child(RandomId);
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String qua = "<b>" + "Miktar : " + "</b>" + updateDishModel.getQuantity();
                        FoodQuantity.setText(Html.fromHtml(qua));
                        String ss = "<b>" + "Açıklama : " + "</b>" + updateDishModel.getDescription();
                        FoodDescription.setText(Html.fromHtml(ss));
                        String pri = "<b>" + "Ücret : ₺" + "</b>" + updateDishModel.getPrice();
                        FoodPrice.setText(Html.fromHtml(pri));
                        Glide.with(OrderDish.this).load(updateDishModel.getImageURL()).into(imageView);

                        chefdata = FirebaseDatabase.getInstance().getReference().child("Chef").child(updateDishModel.getChefId());
                        chefdata.addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                Chef chef = dataSnapshot.getValue(Chef.class);

                                String name = "<b>" + "Şef İsmi: " + "</b>" + chef.getFname() + " " + chef.getLname();
                                ChefName.setText(Html.fromHtml(name));
                                String loc = "<b>" + "Yer : " + "</b>" + chef.getSuburban();
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                                ...
                                                if (num != 0) {
                                                    ...
                                                    reference.setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        ...
                                                        public void onSuccess(Void aVoid) {
                                                            ...
                                                            Toast.makeText(OrderDish.this, "Eklendi", Toast.LENGTH_SHORT).show();
                                                        }
                                                    });
                                    ...
                                    else
                                    {
                                        ...
                                        builder.setMessage("Aynı anda birden fazla şefin yiyecek maddelerini ekleyemezsiniz.");
                                ...
                                data = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(RandomId);
                                data.addListenerForSingleValueEvent(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        UpdateDishModel update = dataSnapshot.getValue(UpdateDishModel.class);
