                                ...
                                if (customerPaymentOrdersList.size() == 0) {
                                    ...
                                    payment.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            FirebaseDatabase.getInstance().getReference("CustomerPaymentOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).removeValue();
                                            FirebaseDatabase.getInstance().getReference("AlreadyOrdered").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).removeValue();
                                            Intent intent = new Intent(PayableOrders.this, CustomerHomeFragment.class);
